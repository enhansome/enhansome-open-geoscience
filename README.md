...
* [SeismicZFP](https://github.com/equinor/seismic-zfp) ⭐ 73 | 🐛 3 | 🌐 Python | 📅 2026-09-25 – ![Python](media/icon/python.png) Convert SEG-Y/ZGY files to compressed [SGZ files](https://github.com/equinor/seismic-zfp/blob/master/docs/file-specification.md) ⭐ 73 | 🐛 3 | 🌐 Python | 📅 2026-09-25 & retrieve arbitrary sub-volumes from these, fast.
...
* [Underworld](https://github.com/underworldcode/underworld2) ⭐ 216 | 🐛 69 | 🌐 C | 📅 2026-07-10 - ![Python](media/icon/python.png) Computational tools for the geodynamics community.
