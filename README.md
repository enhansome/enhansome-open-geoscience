...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,527 | 🐛 71 | 📅 2026-07-21 - ![Awesome](media/icon/awesome.png) Awesome list related to all things Geographic Information Systems (GIS).
...
* [ObsPy](https://github.com/obspy/obspy/wiki) ⭐ 1,333 | 🐛 308 | 🌐 Python | 📅 2026-09-14 – ![Python](media/icon/python.png) Framework for reading, writing and processing seismic and seismological data.
...
* [Pastas](https://github.com/pastas/pastas) ⭐ 454 | 🐛 42 | 🌐 Python | 📅 2026-09-17 – ![Python](media/icon/python.png) Open-source Python framework for the analysis of groundwater time series.
* [Seismic Un\*x](https://github.com/JohnWStockwellJr/SeisUnix) ⭐ 318 | 🐛 114 | 🌐 AGS Script | 📅 2024-09-07 – ![C](media/icon/c.png) Seismic data processing suite.
* [Bruges](https://github.com/agile-geoscience/bruges/tree/master/bruges) ⭐ 315 | 🐛 34 | 🌐 Python | 📅 2023-12-19 – ![Python](media/icon/python.png) Various geophysical equations and tools.
...
* [MDIO](https://mdio.dev) – ![Python](media/icon/python.png) Open source chunked and compressed cloud storage for seismic data based on Zarr with fast seismic ingestion and export tools – [Docs](https://mdio-python.readthedocs.io), [Source](https://github.com/TGSAI/mdio-python) ⭐ 42 | 🐛 45 | 🌐 Python | 📅 2026-09-16.
...
* [GPRPy](https://github.com/NSGeophysics/GPRPy) ⭐ 288 | 🐛 30 | 🌐 Python | 📅 2026-08-28 – ![Python](media/icon/python.png) Multi-format, GUI-based GPR processing and visualization.
...
* [GemPy](https://github.com/cgre-aachen/gempy) ⭐ 1,342 | 🐛 9 | 🌐 Python | 📅 2026-09-12 – ![Python](media/icon/python.png) 3-D structural geological modelling software with implicit modelling and support for stochastic modelling.
* [SimPEG](https://github.com/simpeg/simpeg) ⭐ 675 | 🐛 198 | 🌐 Python | 📅 2026-09-15 – ![Python](media/icon/python.png) Simulation and parameter estimation in geophysics.
* [Landlab](https://github.com/landlab/landlab) ⭐ 441 | 🐛 472 | 🌐 Python | 📅 2026-09-17 – ![Python](media/icon/python.png) Simulate surface processes using a large suite of existing interoperable process components (landscape evolution, sediment dynamics, surface hydrology, ecohydrology), exensible by own modules.
* [LoopStructural](https://github.com/Loop3D/LoopStructural) ⭐ 288 | 🐛 11 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) an open-source 3D structural geological modelling library.
...
* [ResInsight](https://github.com/OPM/ResInsight) ⭐ 218 | 🐛 1,102 | 🌐 C++ | 📅 2026-09-16 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) ResInsight is a powerful open source, cross-platform 3D visualization, curve plotting, and post processing tool for reservoir models and simulations.
...
* [geonotebook](https://github.com/OpenGeoscience/geonotebook) ⭐ 1,089 | 🐛 39 | 🌐 Python | 📅 2019-01-21 – ![Python](media/icon/python.png) Jupyter notebook extension for geospatial visualization and analysis developed by NASA.
...
* [pyrolite](https://github.com/morganjwilliams/pyrolite) ⭐ 173 | 🐛 16 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) Geochemical transformation and visualisation.
* [Thermobar](https://github.com/PennyWieser/Thermobar) ⭐ 65 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-06-25 – ![Python](media/icon/python.png) Thermobarometry, chemometry and mineral equilibrium tool.
...
* [apsg](https://github.com/ondrolexa/apsg) ⭐ 130 | 🐛 1 | 🌐 Python | 📅 2026-09-04 – ![Python](media/icon/python.png) Advanced structural geology analysis and visualisation based on Matplotlib.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,816 | 🐛 550 | 🌐 Python | 📅 2026-09-17 – ![Python](media/icon/python.png) 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK).
...
* [GeoVista](https://github.com/bjlittle/geovista) ⭐ 232 | 🐛 36 | 🌐 Python | 📅 2026-09-16 – ![Python](media/icon/python.png) Cartographic rendering and mesh analytics powered by PyVista.
...
* [GRASS-GIS](https://grass.osgeo.org) – GIS platform for vector and raster geospatial data management, geoprocessing, spatial modelling and visualization, ![C](media/icon/c.png) ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OSGeo/grass) ⭐ 1,166 | 🐛 695 | 🌐 C | 📅 2026-09-17.
...
* [OpendTect](https://dgbes.com/software/opendtect) – Seismic interpretation package, ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OpendTect/OpendTect) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-09-16.
* [Webviz-subsurface](https://github.com/equinor/webviz-subsurface) ⭐ 62 | 🐛 235 | 🌐 Python | 📅 2026-08-26 – ![Python](media/icon/python.png) Webviz-subsurface contains subsurface specific standard webviz containers, which are used as plugins in webviz-config.
