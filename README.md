...
[![Awesome](https://raw.githubusercontent.com/softwareunderground/awesome-open-geoscience/master/media/icon/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,519 | 🐛 105 | 📅 2026-09-02 [![.github/workflows/link\_checker.yml](https://github.com/softwareunderground/awesome-open-geoscience/actions/workflows/link_checker.yml/badge.svg)](https://github.com/softwareunderground/awesome-open-geoscience/actions/workflows/link_checker.yml) ⭐ 1,830 | 🐛 12 | 📅 2026-05-26 [![Contributions](https://img.shields.io/github/issues-pr-closed-raw/softwareunderground/awesome-open-geoscience.svg?label=contributions)](https://github.com/softwareunderground/awesome-open-geoscience/pulls) ⭐ 1,830 | 🐛 12 | 📅 2026-05-26 [![Commits](https://img.shields.io/github/last-commit/softwareunderground/awesome-open-geoscience.svg?label=last%20contribution)](https://github.com/softwareunderground/awesome-open-geoscience/commits/main) ⭐ 1,830 | 🐛 12 | 📅 2026-05-26 [![Chat on slack](https://img.shields.io/badge/slack-join-ff69b4.svg)](https://swung.slack.com/join/shared_invite/enQtNTczNjM4ODMxODMwLTQ3Yjk3MjFmOTJkYzUyZDU3OGI3ZmJhMzIyNzQxYjcyZDM5MWU4OTVmNTBiOTM4Zjg1ZDViOGM3NmQ4OTgzOTk) [![License](https://img.shields.io/github/license/softwareunderground/awesome-open-geoscience.svg)](https://github.com/softwareunderground/awesome-open-geoscience/blob/master/LICENSE) ⭐ 1,830 | 🐛 12 | 📅 2026-05-26
...
* [Wellpathpy](https://github.com/Zabamund/wellpathpy) ⭐ 84 | 🐛 9 | 🌐 Python | 📅 2025-02-08 – ![Python](media/icon/python.png) – Light package to load well deviations.
...
* [SimPEG](https://github.com/simpeg/simpeg) ⭐ 673 | 🐛 185 | 🌐 Python | 📅 2026-08-31 – ![Python](media/icon/python.png) Simulation and parameter estimation in geophysics.
* [Landlab](https://github.com/landlab/landlab) ⭐ 440 | 🐛 476 | 🌐 Python | 📅 2026-09-03 – ![Python](media/icon/python.png) Simulate surface processes using a large suite of existing interoperable process components (landscape evolution, sediment dynamics, surface hydrology, ecohydrology), exensible by own modules.
...
* [BlenderGeoModeller](https://github.com/bsomps/BlenderGeoModeller) ⭐ 53 | 🐛 0 | 🌐 Python | 📅 2025-03-19 – ![Python](media/icon/python.png) A Blender add-on with a collection of tools for 3-D geological modelling.
...
* [ResInsight](https://github.com/OPM/ResInsight) ⭐ 217 | 🐛 1,091 | 🌐 C++ | 📅 2026-09-03 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) ResInsight is a powerful open source, cross-platform 3D visualization, curve plotting, and post processing tool for reservoir models and simulations.
* [ecl](https://github.com/equinor/ecl) ⭐ 128 | 🐛 38 | 🌐 C++ | 📅 2026-09-03 – ![Python](media/icon/python.png) Reading and writing Eclipse reservoir simulator files.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,793 | 🐛 589 | 🌐 Python | 📅 2026-09-03 – ![Python](media/icon/python.png) 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK).
...
* [GeoVista](https://github.com/bjlittle/geovista) ⭐ 230 | 🐛 25 | 🌐 Python | 📅 2026-09-03 – ![Python](media/icon/python.png) Cartographic rendering and mesh analytics powered by PyVista.
...
* [GRASS-GIS](https://grass.osgeo.org) – GIS platform for vector and raster geospatial data management, geoprocessing, spatial modelling and visualization, ![C](media/icon/c.png) ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OSGeo/grass) ⭐ 1,158 | 🐛 704 | 🌐 C | 📅 2026-09-03.
* [OpenGeode](https://github.com/Geode-solutions/OpenGeode) ⭐ 178 | 🐛 21 | 🌐 C++ | 📅 2026-09-03 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) Representation and manipulation of geological models.
* [OpendTect](https://dgbes.com/software/opendtect) – Seismic interpretation package, ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OpendTect/OpendTect) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-09-03.
