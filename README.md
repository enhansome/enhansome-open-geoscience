...
[![Awesome](https://raw.githubusercontent.com/softwareunderground/awesome-open-geoscience/master/media/icon/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,377 | 🐛 106 | 📅 2026-09-02 [![.github/workflows/link\_checker.yml](https://github.com/softwareunderground/awesome-open-geoscience/actions/workflows/link_checker.yml/badge.svg)](https://github.com/softwareunderground/awesome-open-geoscience/actions/workflows/link_checker.yml) ⭐ 1,835 | 🐛 12 | 📅 2026-05-26 [![Contributions](https://img.shields.io/github/issues-pr-closed-raw/softwareunderground/awesome-open-geoscience.svg?label=contributions)](https://github.com/softwareunderground/awesome-open-geoscience/pulls) ⭐ 1,835 | 🐛 12 | 📅 2026-05-26 [![Commits](https://img.shields.io/github/last-commit/softwareunderground/awesome-open-geoscience.svg?label=last%20contribution)](https://github.com/softwareunderground/awesome-open-geoscience/commits/main) ⭐ 1,835 | 🐛 12 | 📅 2026-05-26 [![Chat on slack](https://img.shields.io/badge/slack-join-ff69b4.svg)](https://swung.slack.com/join/shared_invite/enQtNTczNjM4ODMxODMwLTQ3Yjk3MjFmOTJkYzUyZDU3OGI3ZmJhMzIyNzQxYjcyZDM5MWU4OTVmNTBiOTM4Zjg1ZDViOGM3NmQ4OTgzOTk) [![License](https://img.shields.io/github/license/softwareunderground/awesome-open-geoscience.svg)](https://github.com/softwareunderground/awesome-open-geoscience/blob/master/LICENSE) ⭐ 1,835 | 🐛 12 | 📅 2026-05-26
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,516 | 🐛 67 | 📅 2026-07-21 - ![Awesome](media/icon/awesome.png) Awesome list related to all things Geographic Information Systems (GIS).
...
* [Pastas](https://github.com/pastas/pastas) ⭐ 452 | 🐛 39 | 🌐 Python | 📅 2026-09-08 – ![Python](media/icon/python.png) Open-source Python framework for the analysis of groundwater time series.
...
* [Bruges](https://github.com/agile-geoscience/bruges/tree/master/bruges) ⭐ 314 | 🐛 34 | 🌐 Python | 📅 2023-12-19 – ![Python](media/icon/python.png) Various geophysical equations and tools.
* [synthoseis](https://github.com/sede-open/synthoseis) ⭐ 130 | 🐛 4 | 🌐 Python | 📅 2026-09-07 – ![Python](media/icon/python.png) Synthoseis is an open-source, Python-based tool used for generating pseudo-random seismic data.
* [SeisComp](https://github.com/SeisComP/seiscomp) ⭐ 90 | 🐛 0 | 🌐 C++ | 📅 2026-09-04 – ![Python](media/icon/python.png) ![C++](media/icon/cplusplus.png) Seismic observatory automation toolkit. Autodetection, storage, sharing, processing data and more.
...
* [OpendTect-Plugins](https://github.com/waynegm/OpendTect-Plugins) ⭐ 39 | 🐛 4 | 🌐 C++ | 📅 2026-09-09 – ![C++](media/icon/cplusplus.png) open source plugins for the [OpendTect](#platforms) seismic interpretation platform. See [the docs](http://waynegm.github.io/OpendTect-Plugin-Docs) for more information.
...
* [GPRPy](https://github.com/NSGeophysics/GPRPy) ⭐ 284 | 🐛 30 | 🌐 Python | 📅 2026-08-28 – ![Python](media/icon/python.png) Multi-format, GUI-based GPR processing and visualization.
* [RGPR](https://github.com/emanuelhuber/RGPR) ⭐ 225 | 🐛 1 | 🌐 R | 📅 2026-09-03 – ![R](media/icon/r.png) Reads, exports, processes, and plots ground-penetrating radar data.
...
* [lasio](https://github.com/kinverarity1/lasio) ⭐ 401 | 🐛 53 | 🌐 Lasso | 📅 2026-02-13 – ![Python](media/icon/python.png) Reading and writing well data using Log ASCII Standard (LAS) files.
* [Welly](https://github.com/agile-geoscience/welly) ⭐ 375 | 🐛 116 | 🌐 Python | 📅 2025-07-16 – ![Python](media/icon/python.png) Analyzing and processing well log data.
...
* [GemPy](https://github.com/cgre-aachen/gempy) ⭐ 1,340 | 🐛 10 | 🌐 Python | 📅 2026-09-05 – ![Python](media/icon/python.png) 3-D structural geological modelling software with implicit modelling and support for stochastic modelling.
* [SimPEG](https://github.com/simpeg/simpeg) ⭐ 674 | 🐛 192 | 🌐 Python | 📅 2026-09-09 – ![Python](media/icon/python.png) Simulation and parameter estimation in geophysics.
* [Landlab](https://github.com/landlab/landlab) ⭐ 440 | 🐛 474 | 🌐 Python | 📅 2026-09-09 – ![Python](media/icon/python.png) Simulate surface processes using a large suite of existing interoperable process components (landscape evolution, sediment dynamics, surface hydrology, ecohydrology), exensible by own modules.
...
* [disba](https://github.com/keurfonluu/disba) ⭐ 192 | 🐛 2 | 🌐 Python | 📅 2024-12-19 – ![Python](media/icon/python.png) Numba-accelerated computation of surface wave dispersion.
...
* [ResInsight](https://github.com/OPM/ResInsight) ⭐ 218 | 🐛 1,107 | 🌐 C++ | 📅 2026-09-09 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) ResInsight is a powerful open source, cross-platform 3D visualization, curve plotting, and post processing tool for reservoir models and simulations.
* [ecl](https://github.com/equinor/ecl) ⭐ 127 | 🐛 36 | 🌐 C++ | 📅 2026-09-08 – ![Python](media/icon/python.png) Reading and writing Eclipse reservoir simulator files.
...
* [GeostatsPy](https://github.com/GeostatsGuy/GeostatsPy) ⭐ 580 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2025-09-30 – ![Python](media/icon/python.png) GSLIB reimplimented in Python.
...
* [pysgems](https://github.com/robinthibaut/pysgems) ⭐ 62 | 🐛 9 | 🌐 Python | 📅 2026-09-09 – ![Python](media/icon/python.png) Use SGeMS (Stanford geostatistical modelling software) within Python.
...
* [whitebox-tools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,201 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 – ![Python](media/icon/python.png) An advanced geospatial data analysis platform.
* [geonotebook](https://github.com/OpenGeoscience/geonotebook) ⭐ 1,088 | 🐛 39 | 🌐 Python | 📅 2019-01-21 – ![Python](media/icon/python.png) Jupyter notebook extension for geospatial visualization and analysis developed by NASA.
* [Verde](https://github.com/fatiando/verde) ⭐ 667 | 🐛 46 | 🌐 Python | 📅 2026-08-04 – ![Python](media/icon/python.png) processing spatial data to regular grids.
...
* [apsg](https://github.com/ondrolexa/apsg) ⭐ 129 | 🐛 1 | 🌐 Python | 📅 2026-09-04 – ![Python](media/icon/python.png) Advanced structural geology analysis and visualisation based on Matplotlib.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,803 | 🐛 558 | 🌐 Python | 📅 2026-09-08 – ![Python](media/icon/python.png) 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK).
...
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 350 | 🐛 1 | 🌐 Python | 📅 2026-09-07 – ![Python](media/icon/python.png) A Python package for serving tiles from large raster files in the Slippy Maps standard (i.e., `/zoom/x/y.png`) for visualization in Jupyter with `ipyleaflet` or `folium`.
...
* [GeoVista](https://github.com/bjlittle/geovista) ⭐ 230 | 🐛 26 | 🌐 Python | 📅 2026-09-09 – ![Python](media/icon/python.png) Cartographic rendering and mesh analytics powered by PyVista.
...
* [GRASS-GIS](https://grass.osgeo.org) – GIS platform for vector and raster geospatial data management, geoprocessing, spatial modelling and visualization, ![C](media/icon/c.png) ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OSGeo/grass) ⭐ 1,162 | 🐛 704 | 🌐 C | 📅 2026-09-08.
* [OpenGeode](https://github.com/Geode-solutions/OpenGeode) ⭐ 178 | 🐛 23 | 🌐 C++ | 📅 2026-09-09 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) Representation and manipulation of geological models.
* [OpendTect](https://dgbes.com/software/opendtect) – Seismic interpretation package, ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OpendTect/OpendTect) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-09-09.
...
* [IsoplotR](https://github.com/pvermees/IsoplotR) ⭐ 78 | 🐛 0 | 🌐 R | 📅 2026-09-07 – ![R](media/icon/r.png) A free and open-source substitute for Kenneth Ludwig's popular *Isoplot* add-in to Microsoft Excel.
* [pychron](https://github.com/NMGRL/pychron) ⭐ 29 | 🐛 106 | 🌐 Python | 📅 2026-09-08 – ![Python](media/icon/python.png) Data acquisition and processing framework for Ar-Ar geochronology and noble gas mass spectrometry.
