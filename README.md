...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21 - ![Awesome](media/icon/awesome.png) Awesome list related to all things Geographic Information Systems (GIS).
...
* [ObsPy](https://github.com/obspy/obspy/wiki) ⭐ 1,332 | 🐛 303 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) Framework for reading, writing and processing seismic and seismological data.
...
* [Pastas](https://github.com/pastas/pastas) ⭐ 451 | 🐛 44 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) Open-source Python framework for the analysis of groundwater time series.
...
* [SeisComp](https://github.com/SeisComP/seiscomp) ⭐ 89 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 – ![Python](media/icon/python.png) ![C++](media/icon/cplusplus.png) Seismic observatory automation toolkit. Autodetection, storage, sharing, processing data and more.
...
* [OpendTect-Plugins](https://github.com/waynegm/OpendTect-Plugins) ⭐ 39 | 🐛 4 | 🌐 C++ | 📅 2026-02-12 – ![C++](media/icon/cplusplus.png) open source plugins for the [OpendTect](#platforms) seismic interpretation platform. See [the docs](http://waynegm.github.io/OpendTect-Plugin-Docs) for more information.
...
* [SimPEG](https://github.com/simpeg/simpeg) ⭐ 673 | 🐛 186 | 🌐 Python | 📅 2026-08-31 – ![Python](media/icon/python.png) Simulation and parameter estimation in geophysics.
* [Landlab](https://github.com/landlab/landlab) ⭐ 440 | 🐛 476 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) Simulate surface processes using a large suite of existing interoperable process components (landscape evolution, sediment dynamics, surface hydrology, ecohydrology), exensible by own modules.
...
* [ResInsight](https://github.com/OPM/ResInsight) ⭐ 216 | 🐛 1,098 | 🌐 C++ | 📅 2026-09-01 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) ResInsight is a powerful open source, cross-platform 3D visualization, curve plotting, and post processing tool for reservoir models and simulations.
* [ecl](https://github.com/equinor/ecl) ⭐ 128 | 🐛 37 | 🌐 C++ | 📅 2026-09-01 – ![Python](media/icon/python.png) Reading and writing Eclipse reservoir simulator files.
...
* [apsg](https://github.com/ondrolexa/apsg) ⭐ 129 | 🐛 1 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) Advanced structural geology analysis and visualisation based on Matplotlib.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,790 | 🐛 592 | 🌐 Python | 📅 2026-09-01 – ![Python](media/icon/python.png) 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK).
...
* [GeoVista](https://github.com/bjlittle/geovista) ⭐ 230 | 🐛 28 | 🌐 Python | 📅 2026-08-31 – ![Python](media/icon/python.png) Cartographic rendering and mesh analytics powered by PyVista.
...
* [GRASS-GIS](https://grass.osgeo.org) – GIS platform for vector and raster geospatial data management, geoprocessing, spatial modelling and visualization, ![C](media/icon/c.png) ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OSGeo/grass) ⭐ 1,156 | 🐛 704 | 🌐 C | 📅 2026-09-01.
* [OpenGeode](https://github.com/Geode-solutions/OpenGeode) ⭐ 178 | 🐛 21 | 🌐 C++ | 📅 2026-08-31 – ![C++](media/icon/cplusplus.png) ![Python](media/icon/python.png) Representation and manipulation of geological models.
* [OpendTect](https://dgbes.com/software/opendtect) – Seismic interpretation package, ![C++](media/icon/cplusplus.png) source code available at [github](https://github.com/OpendTect/OpendTect) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-09-01.
